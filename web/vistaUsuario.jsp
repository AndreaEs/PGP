                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <select disabled name="rol" class="form-control-static"  >
                                                    ...
                                                    <option class="option-control" value="Desarrollador" <% if (usuario.getTipo() == 'D') {
                                                    out.println("selected");%>> 
                                                Desarrollador </option>
                                                    <option class="option-control" value="Administrador" <% if (usuario.getTipo() == 'A') {
                                                    out.println("selected");%>>
                                                Administrador </option>
                                                    <option class="option-control" value="Jefe de Proyecto" <% if (usuario.getTipo() == 'J') {
                                                    out.println("selected");%>> 
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <select name="maxProy" class="form-control-static"  >
                                                    ...
                                                    <option class="option-control" value="1" <% if (usuario.getMaxProy() == 1) {
                                                    out.println("selected");%>> 
                                                1 </option>
                                                    <option class="option-control" value="2" <% if (usuario.getMaxProy() == 2) {
                                                    out.println("selected");
                                                }%>>
                                                2 </option>
