                  ...
                  <ul class="todo-list">
                    ...
                    <li>
                      ...
                      <%
                        String res="";
                        switch(tmp.get(i+1)){
                            case "TU": res="Trato con usuarios";
                                    break;
                            case "RE": res="Reuniones externas";
                                    break;
                            case "RI": res = "Reuniones internas";
                                    break;
                            case "LD": res="Lectura de documentacion";
                                    break;
                            case "RV": res ="Revision de documentacion";
                                    break;
                            case "ED": res="Elaboracion de documentacion";
                                    break;
                            case "DP": res="Desarrollo de programas";
                                    break;
                            case "VP": res="Verificacion de programas";
                                    break;
                            case "FU": res="Formacion de usuarios";
                                    break;
                            case "FA": res="Formacion de otras actividades";
                                    break;
                            case "S": res="Sin comenzar";
                                    break;
                            case "E": res="En curso";
                                    break;
                            case "F": res="Finalizado";
                                    break;
                            case "C": res="Cerrado";
                                    break;
                            case "A": res ="Administrador";
                                    break;
                            case "J": res="Jefe de proyecto";
                                    break;
                            case "D": res="Desarrollador";
                                    break;
                            default:    res=tmp.get(i+1);
                        }
                      %>
